...
newDerek(
	...
	"derekDoreka",
	"ff00f7",
	"Doreka is fighting for her rights as a female Derekulian warrior",
	150
);
...
if (censoredWords) {
	...
	function goDefeatEvilToaster2() {
		changeScene(
			"It's a jerk wise man, floating in space. You quickly get him to safety.</br>Turns out he was a prisoner of the Derekulians. They were trying to get some wisdom on how to battle jerks from him. It turns out he was just being a wise guy, and they never got anything useful out of him. They were probably happy to finally get rid of him",
			"jerkWiseMan"
		);
		createGoButton("You're safe now","talk",goDefeatEvilToaster3);
	}	
